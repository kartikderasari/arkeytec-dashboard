  ...
  <v-container grid-list-xl>
      <v-flex xs12>
        <v-tabs grow class="pa-0 ma-0" slider-color="primary">
          ...
          <v-tab ripple>Plugins</v-tab>
          <v-tab-item>
            <v-flex xs12 py-5 class="headline font-weight-light">
              Server plugins are web applications that interact with your Server.
              <br />This page is part of the server plugin!
            </v-flex>
            <!-- Empty state handler -->
            <v-flex xs12 v-if="plugins.length === 0">
              <p
                class="title font-weight-light"
              >Hmm, we didn't find any plugins... Which is odd since this page is part of the plugin. 🤔</p>
            </v-flex>
            <v-layout row wrap>
          ...
          <v-tab-item>
            <v-flex xs12 py-5 class="headline font-weight-light">
               plugins are components that extend the SpeckelAdmin web application.
            </v-flex>
            <!-- Empty state handler -->
            <v-flex xs12 v-if="adminPlugins.length === 0">
              <p
                class="title font-weight-light"
              >Hmm, we didn't find any plugins... Are they registered in your `/plugins` folder? 🤔</p>
            </v-flex>
            <v-layout row wrap>
